				...
				switch(month) {
					case 1:
						if(dayOfMonth >= 4 && dayOfMonth < 11) {
							...
							String thisWeekEnd = LocalDate.of(year, month, 04).plusDays(7).toString();
					...
					case 2:
						if(dayOfMonth >= 1 && dayOfMonth < 8) {
							...
							String thisWeekEnd = LocalDate.of(year, month, 01).plusDays(7).toString();
							label.setText(thisWeekStart+" ~ "+thisWeekEnd);
							String[] str2 = thisWeekStart.split("-");
							String result2 = str2[0]+"y"+str2[1]+"m"+str2[2]+"d";
							list = MySQLConnect.getDataWeekly(result2);
					...
					case 4:
						if(dayOfMonth >= 1 && dayOfMonth < 5) {
							...
							String thisWeekEnd = LocalDate.of(year, month-1, 29).plusDays(7).toString();
							label.setText(thisWeekStart+" ~ "+thisWeekEnd);
							String[] str2 = thisWeekStart.split("-");
							String result2 = str2[0]+"y"+str2[1]+"m"+str2[2]+"d";
							list = MySQLConnect.getDataWeekly(result2);
					...
					case 5:
						if(dayOfMonth >= 1 && dayOfMonth < 3) {
							...
							String thisWeekEnd = LocalDate.of(year, month-1, 26).plusDays(7).toString();
							label.setText(thisWeekStart+" ~ "+thisWeekEnd);
							String[] str2 = thisWeekStart.split("-");
							String result2 = str2[0]+"y"+str2[1]+"m"+str2[2]+"d";
							list = MySQLConnect.getDataWeekly(result2);
